  ...
  return (
    <div>
      ...
      <section className="py-16 bg-gradient-to-b from-white to-emerald-50 relative overflow-hidden">
        ...
        <div
          className="absolute top-0 left-0 w-64 h-64 bg-gradient-to-br from-[#1FA58A]/10 to-transparent rounded-full blur-3xl animate-pulse"
          style={{ animationDuration: "8s" }}
        ></div>
        <div
          className="absolute bottom-0 right-0 w-80 h-80 bg-gradient-to-tl from-[#2e5b8e]/10 to-transparent rounded-full blur-3xl animate-pulse"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <div className="inline-block mb-10">
            <h2
              className="text-3xl md:text-5xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-[#1FA58A] to-[#2e5b8e] drop-shadow-md transform hover:scale-105 transition-transform duration-300 relative"
              style={{
            ...
            >
              Chief Guest
              <span className="absolute -bottom-2 left-0 right-0 h-1 bg-gradient-to-r from-[#1FA58A] to-[#2e5b8e] transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left"></span>
            </h2>
            <div
              className="h-1 w-24 mx-auto mt-3 bg-gradient-to-r from-[#1FA58A] to-[#2e5b8e] rounded-full"
          ...
          <div className="flex flex-col items-center justify-center">
            <div
              className="w-full max-w-md overflow-hidden rounded-2xl shadow-[0_20px_50px_rgba(31,165,138,0.3)] mb-8 transform hover:scale-[1.02] transition-all duration-500 hover:shadow-[0_25px_60px_rgba(31,165,138,0.4)] relative group"
            ...
            >
              ...
              <div
                className="relative p-1 bg-white rounded-2xl z-10"
                style={{
              ...
              >
                <img
                  src="/chiefguest1.png"
                  alt="Chief Guest"
                  className="w-full h-auto object-cover rounded-xl transform transition-transform duration-700 hover:scale-105"
                />

                {/* Shine effect */}
                <div
                  className="absolute inset-0 bg-gradient-to-tr from-white/0 via-white/80 to-white/0 rounded-xl opacity-0 group-hover:opacity-30 transition-opacity duration-700 z-30"
                  style={{
            ...
            <div
              className="transform hover:scale-105 transition-all duration-300 bg-white/50 backdrop-blur-sm py-4 px-6 rounded-xl shadow-md hover:shadow-lg"
              style={{ animation: "float 5s ease-in-out infinite 0.5s" }}
            >
              <h3
                className="text-2xl md:text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-[#1FA58A] to-[#2e5b8e] mb-3 drop-shadow-sm"
                style={{
                  backgroundSize: "200% auto",
                  animation: "shimmer 3s linear infinite",
                }}
        ...
        <div className="relative z-10 max-w-screen-xl mx-auto px-4 sm:px-8 lg:px-12">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-sm md:text-xl max-w-3xl mx-auto mt-3 text-[#336699] font-medium leading-relaxed">
              Explore our recognition categories and find the perfect award for
              your achievements.
            </p>
          </div>
            ...
            <Link href="/categories/private-healthcare" className="group">
              <div className="bg-white rounded-lg shadow-md overflow-hidden transition-all duration-300 hover:shadow-xl hover:scale-105 h-full flex flex-col">
                ...
                <div className="p-5 flex-grow flex flex-col justify-between">
                  <h3 className="text-xl font-bold text-[#2e5b8e] mb-2">
                    Private Healthcare Recognition
                  </h3>
                  <p className="text-sm text-gray-600 mb-4">
                    Honoring excellence in private healthcare services and
                    institutions.
                  </p>
            ...
            <Link href="/categories/ayush-health" className="group">
              <div className="bg-white rounded-lg shadow-md overflow-hidden transition-all duration-300 hover:shadow-xl hover:scale-105 h-full flex flex-col">
                ...
                <div className="p-5 flex-grow flex flex-col justify-between">
                  ...
                  <p className="text-sm text-gray-600 mb-4">
                    Celebrating excellence in Ayurveda, Yoga, Unani, Siddha, and
                    Homeopathy services.
                  </p>
                  <div className="mt-auto">
                    <span className="inline-flex items-center text-[#60afaa] font-medium group-hover:text-[#015D67]">
            ...
            <Link href="/categories/healthcare-manufacturers" className="group">
              <div className="bg-white rounded-lg shadow-md overflow-hidden transition-all duration-300 hover:shadow-xl hover:scale-105 h-full flex flex-col">
                ...
                <div className="p-5 flex-grow flex flex-col justify-between">
                  ...
                  <p className="text-sm text-gray-600 mb-4">
                    Recognizing innovation and excellence in healthcare
            ...
            <Link href="/categories/jury-choice" className="group">
              <div className="bg-white rounded-lg shadow-md overflow-hidden transition-all duration-300 hover:shadow-xl hover:scale-105 h-full flex flex-col">
                ...
                <div className="p-5 flex-grow flex flex-col justify-between">
                  ...
                  <p className="text-sm text-gray-600 mb-4">
                    Special recognitions awarded by our distinguished jury for
